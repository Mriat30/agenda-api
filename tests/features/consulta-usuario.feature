...
Característica: Consulta de usuario registrado
  ...
  Escenario: CU1: Consulta exitosa de un usuario registrado
  ...
  Escenario: CU3: Consulta exitosa por id de telegram de un usuario registrado
    ...
    Entonces la consulta es exitosa y obtengo el nombre "Juan", idTelegram "55555" y telefono "1234567890"
